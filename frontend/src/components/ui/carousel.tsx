...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        'absolute flex h-9 w-9 items-center justify-center rounded-full border border-white/20 bg-white/10 text-white backdrop-blur-sm transition-all hover:bg-white/20 disabled:opacity-30',
