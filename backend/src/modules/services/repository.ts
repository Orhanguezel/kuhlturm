...
import { publicUrlOf } from '@ensotek/shared-backend/modules/storage/_util';
...
export async function listServices(params: {
  ...
  if (params.category_id) filters.push(eq(services.category_id, params.category_id));
  if (params.sub_category_id) filters.push(eq(services.sub_category_id, params.sub_category_id));
