...
import { categories, categoryI18n } from '@ensotek/shared-backend/modules/categories/schema';
import { subCategories, subCategoryI18n } from '@ensotek/shared-backend/modules/subcategories/schema';
