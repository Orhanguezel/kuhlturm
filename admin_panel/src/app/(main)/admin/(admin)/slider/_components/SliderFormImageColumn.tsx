  ...
  return (
    <div className="space-y-3">
      <AdminImageUploadField
        ...
        helperText={t("admin.slider.formImage.imageHelp")}
        bucket="public"
      ...
      <div className="space-y-2">
        <div className="font-medium text-sm">{t("admin.slider.formImage.altLabel")}</div>
        <input
        ...
        />
        <p className="text-muted-foreground text-xs">{t("admin.slider.formImage.altHelp")}</p>
      </div>
    </div>
  );
}
