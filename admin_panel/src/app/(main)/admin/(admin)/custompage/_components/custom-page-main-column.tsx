...
export const CustomPageMainColumn: React.FC<Props> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <label className="mb-1 block text-muted-foreground text-xs">{t("admin.customPage.form.title")}</label>
        <input
          type="text"
      ...
      <div>
        <label className="mb-1 block text-muted-foreground text-xs">Slug</label>
        <input
          type="text"
          className="w-full rounded-md border bg-background px-3 py-2 text-sm"
          value={values.slug}
      ...
      <div>
        <label className="mb-1 block text-muted-foreground text-xs">{t("admin.customPage.form.summary")}</label>
        <textarea
          className="w-full rounded-md border bg-background px-3 py-2 text-sm"
          rows={3}
