  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <AdminImageUploadField
        ...
        helperText={t("admin.customPage.form.coverHelperText")}
        bucket="public"
      ...
      {onGalleryUrlsChange ? (
        <AdminImageUploadField
          ...
          helperText={t("admin.customPage.form.galleryHelperText")}
          bucket="public"
          ...
          onSelectAsCover={(url) => (onSelectAsCover ? onSelectAsCover(url) : onFeaturedImageChange(url))}
