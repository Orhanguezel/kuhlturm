    ...
    <Card>
      ...
      <CardContent className="space-y-8">
        ...
        <fieldset className="space-y-4">
          <legend className="font-semibold text-foreground text-sm">{t("admin.siteSettings.branding.identity")}</legend>

          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              <Label htmlFor="branding_app_name">{t("admin.siteSettings.branding.fields.appName")}</Label>
              <Input
                id="branding_app_name"
                value={form.app_name}
                onChange={(e) => handleChange("app_name", e.target.value)}
                placeholder={t(
                  `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.app_name}`,
                )}
                disabled={busy}
              />
            </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="branding_app_copyright">{t("admin.siteSettings.branding.fields.copyright")}</Label>
              <Input
                id="branding_app_copyright"
                value={form.app_copyright}
                onChange={(e) => handleChange("app_copyright", e.target.value)}
                placeholder={t(
                  `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.app_copyright}`,
                )}
                disabled={busy}
              />
            </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="branding_html_lang">{t("admin.siteSettings.branding.fields.htmlLang")}</Label>
              <Input
                id="branding_html_lang"
                value={form.html_lang}
                onChange={(e) => handleChange("html_lang", e.target.value)}
                placeholder={t(
                  `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.html_lang}`,
                )}
                disabled={busy}
              />
              <p className="text-muted-foreground text-xs">{t("admin.siteSettings.branding.fields.htmlLangHelp")}</p>
            </div>
          </div>
        </fieldset>
        ...
        {/* Visual */}
        <fieldset className="space-y-4">
          <legend className="font-semibold text-foreground text-sm">{t("admin.siteSettings.branding.visual")}</legend>

          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              <Label htmlFor="branding_theme_color">{t("admin.siteSettings.branding.fields.themeColor")}</Label>
              <div className="flex items-center gap-2">
                <Input
                  ...
                  placeholder={t(
                    `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.theme_color}`,
                  )}
                  disabled={busy}
                  className="flex-1"
                />
                {form.theme_color && (
                  <div className="size-9 shrink-0 rounded-md border" style={{ backgroundColor: form.theme_color }} />
                )}
              </div>
            </div>

            <div className="space-y-2">
              <Label htmlFor="branding_og_image">{t("admin.siteSettings.branding.fields.ogImage")}</Label>
              <Input
                id="branding_og_image"
                value={form.og_image}
                onChange={(e) => handleChange("og_image", e.target.value)}
                placeholder={t(
                  `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.og_image}`,
                )}
                disabled={busy}
              />
            </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="branding_favicon_16">{t("admin.siteSettings.branding.fields.favicon16")}</Label>
              <Input
                id="branding_favicon_16"
                value={form.favicon_16}
                onChange={(e) => handleChange("favicon_16", e.target.value)}
                placeholder={t(
                  `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.favicon_16}`,
                )}
                disabled={busy}
              />
            </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="branding_favicon_32">{t("admin.siteSettings.branding.fields.favicon32")}</Label>
              <Input
                id="branding_favicon_32"
                value={form.favicon_32}
                onChange={(e) => handleChange("favicon_32", e.target.value)}
                placeholder={t(
                  `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.favicon_32}`,
                )}
                disabled={busy}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder={t(
                  `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.apple_touch_icon}`,
                )}
                disabled={busy}
              />
            </div>
        ...
        {/* Meta / SEO */}
        <fieldset className="space-y-4">
          <legend className="font-semibold text-foreground text-sm">{t("admin.siteSettings.branding.metaSeo")}</legend>

          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              <Label htmlFor="branding_meta_title">{t("admin.siteSettings.branding.fields.metaTitle")}</Label>
              <Input
                id="branding_meta_title"
                value={form.meta_title}
                onChange={(e) => handleChange("meta_title", e.target.value)}
                placeholder={t(
                  `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.meta_title}`,
                )}
                disabled={busy}
              />
            </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="branding_og_url">{t("admin.siteSettings.branding.fields.ogUrl")}</Label>
              <Input
                id="branding_og_url"
                value={form.og_url}
                onChange={(e) => handleChange("og_url", e.target.value)}
                placeholder={t(
                  `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.og_url}`,
                )}
                disabled={busy}
              />
            </div>
          ...
          <div className="space-y-2">
            <Label htmlFor="branding_meta_description">{t("admin.siteSettings.branding.fields.metaDescription")}</Label>
            <Textarea
              ...
              placeholder={t(
                `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.meta_description}`,
              )}
              disabled={busy}
            />
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              <Label htmlFor="branding_og_title">{t("admin.siteSettings.branding.fields.ogTitle")}</Label>
              <Input
                id="branding_og_title"
                value={form.og_title}
                onChange={(e) => handleChange("og_title", e.target.value)}
                placeholder={t(
                  `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.og_title}`,
                )}
                disabled={busy}
              />
            </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="branding_twitter_card">{t("admin.siteSettings.branding.fields.twitterCard")}</Label>
              <Input
                id="branding_twitter_card"
                value={form.twitter_card}
                onChange={(e) => handleChange("twitter_card", e.target.value)}
                placeholder={t(
                  `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.twitter_card}`,
                )}
                disabled={busy}
              />
            </div>
          ...
          <div className="space-y-2">
            <Label htmlFor="branding_og_description">{t("admin.siteSettings.branding.fields.ogDescription")}</Label>
            <Textarea
              ...
              placeholder={t(
                `admin.siteSettings.branding.placeholders.${SITE_SETTINGS_BRANDING_PLACEHOLDER_KEYS.og_description}`,
              )}
              disabled={busy}
            />
          </div>
