...
export function ThemePreview({ colors, t }: ThemePreviewProps) {
  return (
    <div className="overflow-hidden rounded-lg border" style={{ backgroundColor: colors.background }}>
      ...
      >
        <span className="font-bold text-sm">{t("preview.brandName")}</span>
      ...
      <div className="space-y-3 p-4" style={{ backgroundColor: colors.surfaceBase }}>
        ...
        >
          <div className="font-semibold text-sm" style={{ color: colors.textStrong }}>
        ...
        <div className="flex gap-2">
          <div className="rounded-md px-3 py-1.5 text-white text-xs" style={{ backgroundColor: colors.primary }}>
        ...
        <div className="rounded-md p-3" style={{ backgroundColor: colors.surfaceDarkBg }}>
          <div className="font-semibold text-xs" style={{ color: colors.surfaceDarkHeading }}>
