              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    />
                    <div className="mt-2 font-bold text-2xl" style={{ fontFamily: draft.typography.fontHeading }}>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <div className="mt-2 text-sm" style={{ fontFamily: draft.typography.fontBody }}>
                      {t("fontBodyPreview")}
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  ...
                  <div className="mt-3 flex gap-3">
                    {THEME_RADIUS_PREVIEW_SIZES.map((size, i) => (
                      <div
                        key={size}
                        className="flex size-16 items-center justify-center border-2 font-medium text-xs"
                        style={{
