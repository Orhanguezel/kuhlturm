...
const normalizeLocale = (v: unknown): string => (typeof v === "string" ? v.trim().toLowerCase() : "");
...
export const ServicesHeader: React.FC<ServicesHeaderProps> = ({
  ...
  }, [localesLoading, effectiveLocale, filters.locale, onChangeFilters]);
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-2">
            ...
            {!localesLoading && localeOptions.length === 0 ? (
              <p className="text-destructive text-xs">{t("admin.services.header.localeEmptyError")}</p>
            ) : null}
          </div>
