        ...
        <Card className="xl:col-span-2">
          ...
          <CardContent className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Select value={form.type} onValueChange={(v) => setForm((p) => ({ ...p, type: v as ResumeType }))}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <CardContent className="grid gap-4">
            ...
            <div className="grid gap-2 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  type="number"
                  value={form.score_scale ?? 100}
                  onChange={(e) => setForm((p) => ({ ...p, score_scale: Number(e.target.value) }))}
                />
              </div>
            </div>
