...
export const chatAdminApi = baseApi.injectEndpoints({
  endpoints: (build) => ({
    ...
    listChatThreadsAdmin: build.query<ChatThreadsResponse, ChatListThreadsParams | undefined>({
    ...
    listChatMessagesAdmin: build.query<ChatMessagesResponse, { threadId: string; params?: ChatListMessagesParams }>({
    ...
    postChatMessageAdmin: build.mutation<ChatMessageResponse, { threadId: string; body: ChatPostMessageBody }>({
    ...
    takeOverChatThreadAdmin: build.mutation<ChatThreadResponse, { threadId: string; body?: ChatAdminTakeoverBody }>({
      query: ({ threadId, body }): FetchArgs => ({
    ...
    listChatKnowledgeAdmin: build.query<ChatAiKnowledgeListResponse, ChatAiKnowledgeListParams | undefined>({
    ...
    updateChatKnowledgeAdmin: build.mutation<ChatAiKnowledgeItem, { id: string; body: ChatAiKnowledgeUpdateBody }>({
