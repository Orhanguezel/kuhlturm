...
import type { PatchResumeInput, ResumeListParams, ResumeMerged, UpsertResumeInput } from "@/integrations/shared";
...
export const resumeAdminApi = baseApi.injectEndpoints({
  endpoints: (b) => ({
    listResumeAdmin: b.query<ResumeMerged[], ResumeListParams | undefined>({
    ...
    getResumeBySlugAdmin: b.query<ResumeMerged, { slug: string; locale?: string; default_locale?: string }>({
