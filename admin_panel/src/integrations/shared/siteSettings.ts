...
import type { JsonLike, ValueType } from "@/integrations/shared";
import { parseJsonObject, toBool, toNum, uiText } from "@/integrations/shared";

/** FE/BE arasında ayakta kalacak JSON-benzeri tip */
export type SettingValue = string | number | boolean | null | { [k: string]: SettingValue } | SettingValue[];
...
export function normalizePublicSiteSettingItem(r: { key: string; value: unknown; updated_at?: string }): SiteSetting {
  return {
...
export function normalizeUiServicesSettingValue(value: unknown): UiServicesCopy {
  ...
  return {
    page: {
      ...
      tagline_fallback: pick(page, "tagline_fallback", "Creative. Unique. Reality.", "page_tagline_fallback"),
      card_fallback_title: pick(page, "card_fallback_title", "Untitled", "page_card_fallback_title"),
    ...
    section1: {
      ...
      card_fallback_title: pick(section1, "card_fallback_title", "Untitled", "section1_card_fallback_title"),
    },
    section2: {
      ...
      card_fallback_title: pick(section2, "card_fallback_title", "Untitled", "section2_card_fallback_title"),
      ...
      footer_link_label: pick(section2, "footer_link_label", "Reach out!", "section2_footer_link_label"),
    },
    detail: {
      ...
      description_label: pick(detail, "description_label", "Description", "detail_description_label"),
      ...
      tagline_fallback: pick(detail, "tagline_fallback", "Creative. Unique. Reality.", "detail_tagline_fallback"),
    },
  };
}
...
export function normalizeUiProjectSettingValue(value: unknown): UiProjectCopy {
  ...
  return {
    ...
    projects2: {
      ...
      completion_label: pick(projects2, "completion_label", "Completion Time", "projects2_completion_label"),
      technologies_label: pick(projects2, "technologies_label", "Technologies", "projects2_technologies_label"),
      ...
      sample_completion: pick(projects2, "sample_completion", "6 months", "projects2_sample_completion"),
    ...
    work: {
      ...
      label_completion_time: pick(work, "label_completion_time", "Completion Time", "work_label_completion_time"),
      ...
      empty_text: pick(work, "empty_text", "Please add projects from admin panel.", "work_empty_text"),
    },
    detail: {
      loading: pick(detail, "loading", "Loading...", "detail_loading"),
      ...
      key_features_label: pick(detail, "key_features_label", "Key Features", "detail_key_features_label"),
...
export function normalizeUiBlogSettingValue(value: unknown): UiBlogCopy {
  ...
  return {
    blog1: {
      ...
      intro: pick(blog1, "intro", "Explore the insights and trends shaping our industry", "blog1_intro"),
    ...
    blog2: {
      ...
      card1_title: pick(blog2, "card1_title", "Optimize Your Web Application for Speed", "blog2_card1_title"),
      ...
      card2_title: pick(blog2, "card2_title", "Best Practices for Secure Web Development", "blog2_card2_title"),
    ...
    detail: {
      ...
      not_found_text_prefix: pick(detail, "not_found_text_prefix", "Invalid slug:", "detail_not_found_text_prefix"),
...
function normalizeResearchItems(raw: unknown, fallback: UiResumeResearchItem[]): UiResumeResearchItem[] {
...
export function normalizeUiResumeSettingValue(value: unknown): UiResumeCopy {
  ...
  const educationResearch = normalizeResearchItems((education2 as any)?.research_items, RESUME_RESEARCH_FALLBACK);

  const experienceResearch = normalizeResearchItems((experience2 as any)?.research_items, RESUME_RESEARCH_FALLBACK);
  ...
  return {
    resume1: {
      ...
      empty_education: pick(resume1, "empty_education", "No education entries found.", "resume1_empty_education"),
      empty_experience: pick(resume1, "empty_experience", "No experience entries found.", "resume1_empty_experience"),
      marquee_text: pick(resume1, "marquee_text", "Branding . Marketing . User Interface", "resume1_marquee_text"),
    },
    education2: {
      ...
      error_text: pick(education2, "error_text", "Education data could not be loaded.", "education2_error_text"),
      empty_label: pick(education2, "empty_label", "No entries", "education2_empty_label"),
      empty_text: pick(education2, "empty_text", "No education entries found.", "education2_empty_text"),
      research_heading: pick(education2, "research_heading", "Researched", "education2_research_heading"),
    ...
    experience2: {
      ...
      error_text: pick(experience2, "error_text", "Education data could not be loaded.", "experience2_error_text"),
      empty_label: pick(experience2, "empty_label", "No entries", "experience2_empty_label"),
      empty_text: pick(experience2, "empty_text", "No education entries found.", "experience2_empty_text"),
      research_heading: pick(experience2, "research_heading", "Researched", "experience2_research_heading"),
  ...
  return {
    home1: {
      ...
      description: pick(
        home1,
        "description",
        "Kühlturm — Industrial cooling tower solutions. We help businesses with high-quality cooling systems and engineering services.",
        "home1_description",
      ),
      ...
      decor_image: pick(home1, "decor_image", "/assets/imgs/hero/hero-1/decorate.png", "home1_decor_image"),
    ...
    home2: {
      ...
      description_html: pick(
        home2,
        "description_html",
        '&lt;p&gt;<span class="text-dark">At</span> <span class="text-secondary-2">kuhlturm.com</span><span class="text-dark">, we provide industrial cooling tower solutions with</span> <span class="text-secondary-2">engineering excellence</span> and <span class="text-secondary-2">reliable service</span><span class="text-dark">.</span>&lt;/p&gt;',
      ...
      hero_image: pick(home2, "hero_image", "assets/imgs/home-page-2/hero-1/people.png", "home2_hero_image"),
      hero_image_alt: pick(home2, "hero_image_alt", "Orhan Guzel", "home2_hero_image_alt"),
      icon_image: pick(home2, "icon_image", "assets/imgs/home-page-2/hero-1/icon.svg", "home2_icon_image"),
...
export function normalizeUiHome3SettingValue(value: unknown): UiHome3Copy {
  ...
  return {
    hero: {
      ...
      signature_image: pick(hero, "signature_image", "/assets/imgs/home-page-3/hero/signature.png", "signature_image"),
    ...
    resume: {
      ...
      empty_education: pick(resume, "empty_education", "No education entries.", "resume_empty_education"),
    ...
    contact: {
      ...
      email: pick(contact, "email", "info@kuhlturm.com", "contact_email"),
      skype: pick(contact, "skype", "Kühlturm", "contact_skype"),
  ...
  if (Array.isArray(raw)) {
    const items = raw
      .map((item) => {
        ...
        const label_top = uiText((o as any).label_top) || uiText((o as any).labelTop) || uiText((o as any).top);
        const label_bottom =
          uiText((o as any).label_bottom) || uiText((o as any).labelBottom) || uiText((o as any).bottom);
...
export function normalizeUiStaticSettingValue(value: unknown): UiStaticCopy {
  ...
  const items1 = normalizeStaticItems((static1 as any).items ?? (root as any).static1_items, STATIC1_FALLBACK);
  const items2 = normalizeStaticItems((static2 as any).items ?? (root as any).static2_items, STATIC2_FALLBACK);
...
function normalizeCoporationJournalItems(raw: unknown, fallback: UiCoporationJournalItem[]): UiCoporationJournalItem[] {
  if (Array.isArray(raw)) {
    const items = raw
      .map((item) => {
        const o = parseJsonObject(item);
...
export function normalizeUiCoporationSettingValue(value: unknown): UiCoporationCopy {
  ...
  const skype_value = pick(contact, "skype_value", "Kühlturm", "contact_skype_value");
  ...
  const email_value = pick(contact, "email_value", "info@kuhlturm.com", "contact_email_value");
  const email_href = pick(contact, "email_href", "mailto:info@kuhlturm.com", "contact_email_href");
...
export const SITE_SETTINGS_BRAND = "kuhlturm";
...
export function buildSiteSettingsLocalesOptions(rows: AppLocaleLike[]): SiteSettingsLocaleOption[] {
  if (!Array.isArray(rows) || rows.length === 0) return [];
  return rows
    .filter((r): r is AppLocaleLike & { code: string } => r != null && typeof r.code === "string" && r.code.trim() !== "")
    .map((r) => ({
      value: r.code.trim(),
...
export function pickInitialSiteSettingsLocale(rows: AppLocaleLike[], preferredLocale?: string): string {
  if (!Array.isArray(rows) || rows.length === 0) return preferredLocale || "de";
...
export function pickInitialSiteSettingsDetailLocale(
  arg:
    | AppLocaleLike[]
    | { localeFromQuery?: string; localeOptions?: SiteSettingsLocaleOption[]; defaultLocaleFromDb?: string },
