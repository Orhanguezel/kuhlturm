...
import { UI_FALLBACK_EN, useUIStrings } from "./ui";
...
const SECTION_KEYS: Record<UiSectionKey, readonly string[]> = {
  ...
  ui_about: ["ui_about_subprefix", "ui_about_sublabel", "ui_about_view_all", "ui_about_fallback_title"],

  ui_about_stats: ["ui_about_stats_refs_title", "ui_about_stats_projects_title", "ui_about_stats_years_title"],
  ...
  ui_references: ["ui_references_subprefix", "ui_references_sublabel", "ui_references_title", "ui_references_view_all"],
